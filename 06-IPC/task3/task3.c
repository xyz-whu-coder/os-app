...
void init()
{
    ...
    sem_produce = semget((key_t)0x3333, REPEATS, FLAG);
...
int main()
{
    ...
    if (pid > 0)
    {
        ...
        for (i = 0; i < REPEATS; i++)
        {
            ...
            semop(sem_consume, &sbuf, REPEATS);
            /* OK */
    ...
    else if (pid == 0)
    {
        ...
        for (i = 0; i < REPEATS; i++)
        {
            ...
            semop(sem_produce, &sbuf, REPEATS);
            /* OK */
